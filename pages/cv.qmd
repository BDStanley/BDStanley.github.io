...
format:
  ...
  typst:
    ...
    include-in-header:
      text: |
        #show raw: set text(font: "Minion Pro", size: 10pt, weight: "black", fill: rgb("#999999"))
        #show strong: set text(weight: "bold")
        #set block(below: 2em)
        #show heading.where(level: 2): set block(above: 1.4em, below: 0.80em, spacing: 0em)
...
```{=typst}
#align(center)[
  #text(size: 16pt, weight: "bold")[Ben Stanley]\
  Associate Professor of Political Science \
  SWPS University\
  ul. Chodakowska 19/31\
  03-815 Warsaw\
...
::: {style="flex: 1;"}
**Phone:** <a href="tel:+48798814801">(+48)798814801</a>\
**Email:** <a href="mailto:bstanley@swps.edu.pl">bstanley\@swps.edu.pl</a>\
**Website:** <a href="https://www.benstanley.eu">benstanley.eu</a>\
...
#align(center)[
  #text(
    size: 9pt,
    font: "Minion Pro",
    fill: rgb("#555555"),  // Gray for subtlety
    [*Gender:* Male #h(1em) *Date of birth:* 17.05.1979 #h(1em) *Nationality:* British/Irish #h(1em) *Residence:* Poland\
     *Phone:* (+48)798814801 #h(1em) *Email:* bstanley\@swps.edu.pl #h(1em)
     *Website:* benstanley.eu #h(1em) *ORCID:* 0000-0001-6932-1046]
  )
]
...
{{< include ../includes/list-of-publications_cv.qmd >}}
...
`2025` Book Launch: Stanley Bill and Ben Stanley on Poland's Illiberal Revolution, Sidney Sussex College, University of Cambridge, 24 October 2025.
...
`2025` Author Meets Critics: Good Change: The Rise and Fall of Democratic Illiberalism. *APSA Annual Meeting*, Vancouver, 12 September 2025.

Measuring a Moving Target? Populist Attitudes When Populists are In and Out of Power. *ECPR General Conference*, Thessaloniki, 28 August 2025.

Trading Democracy Off: Exploring Populist, Illiberal and Authoritarian Challenges to Liberal Democracy. *IPSA World Congress*, Seoul, 14th July 2025.

Pocketbook or Rosary Isn't Dead...It's Not Even Past! *PIASA Annual Meeting 2025*, Columbia University, 6th June 2025.
...
International Business: The Challenges of Globalization, undergraduate (2016-2018)

The Social Psychology of Democracies in Transition, undergraduate (2021-2026)

Europa Środkowo-Wschodnia w okresie przejściowym: polityczne, gospodarcze i społeczne zmiany ery postkomunistycznej \[*Central and Eastern Europe in Transition: Political, Economic and Social Change in the Post-Communist Era*\], undergraduate (2023)

Unia Europejska i jej instytucje \[*The European Union and its Institutions*\], undergraduate (2023-2026)

Demokratyzacja i regres demokracji \[*Democratization and Democratic Backsliding*\], undergraduate (2025)
...
Introduction to Political Psychology, undergraduate (2019-2020, 2022-2023)

Social Psychology of Conspiracy Theories, undergraduate (2021-2022, 2024)

Rola teorii spiskowych we współczesnym życiu społecznym i politycznym, undergraduate (2023)

The Psychology of Prejudice, undergraduate (2022)

Social Research Methodology, undergraduate (2022-2023)

Wprowadzenie do metodologii badań społecznych \[*Introduction to Social Research Methodology*\], undergraduate (2025)

Populizm, natywizm i problemy współczesnej demokracji liberalnej \[*Populism, Nativism and the Problems of Contemporary Liberal Democracy*\], undergraduate (2022)

Savoir vivre in business, undergraduate (2024)

Savoir vivre w biznesie \[*Savoir Vivre in Business*\], undergraduate (2024)
...
Komunikowanie wyników badań \[*Oral Presentation Skills*\], postgraduate (2019)

Professional Communication Skills: Presentations, postgraduate (2018-2019)

Professional Communication Skills: Writing in Business, postgraduate (2018-2021)

Advanced English in Research, postgraduate (2021)

Język angielski w zastosowaniu zawodowym \[*English for Professional Purposes*\], postgraduate (2019-2020, 2024-2026)

Critical Analysis and Thinking, postgraduate (2024)

Dziennikarstwo danych \[*Data Journalism*\], postgraduate (2025)

Wyzwania życia publicznego: uprzedzenia \[*Challenges of Public Life: Prejudice*\], undergraduate (2022-2025)

Wyzwania życia publicznego: polaryzacja \[*Challenges of Public Life: Polarisation*\], undergraduate (2022)

Podstawy dziennikarstwa danych \[*Fundamentals of Data Journalism*\], undergraduate (2026)
...
Rector's Award for Scientific Achievements 2024/2025, SWPS University, 2025.

Rector's Award for Scientific Achievements 2023/2024, SWPS University, 2024.
...
Doctoral thesis, Karolina Zbytniewska, "Populist skirmishers and the erosion of civility: a new force in populist movements", *University of Warsaw*, 2025.
